  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="showShopInfo">
    ...
    <!-- 优惠活动摘要 -->
    <div class="shop-header-discounts" v-if="info.supports" @click="showDiscountInfo">
    ...
    <!-- 商家详细信息 -->
    <div class="shop-brief-modal" v-if="shopInfoShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="showShopInfo">
    ...
    <!-- 优惠详情 -->
    <div class="activity-sheet" v-if="discountInfoShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="showDiscountInfo">
          <span class="iconfont icon-guanbi"></span>
        </div>
      </div>
...
export default {
  name: "ShopHeader-Comp",
  data() {
    return {
        supportsClasses: ['activity-green', 'activity-red', 'activity-orange'],
        shopInfoShow: false, //商家详细信息弹出框显示，false为不显示，true为显示
        discountInfoShow: false, //优惠活动详细信息展示，false为不显示，true为显示
    }
  },
  computed: {
    ...mapState(['info'])
  ...
  methods: {
    ...
    showDiscountInfo(){
        this.discountInfoShow = !this.discountInfoShow
    }
  },
};
</script>
